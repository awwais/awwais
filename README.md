<div style="display: flex; align-items: center; background: #1a1a1a; border: 2px solid #61dafb; border-radius: 5px; padding: 20px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
